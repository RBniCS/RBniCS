...
def OfflineOnlineClassMethod(problem_name):
    if problem_name not in _offline_online_class_method_cache:
        ...
        _offline_online_class_method_cache[problem_name] = _OfflineOnlineClassMethod
    
    return _offline_online_class_method_cache[problem_name]
        
_offline_online_class_method_cache = dict()
