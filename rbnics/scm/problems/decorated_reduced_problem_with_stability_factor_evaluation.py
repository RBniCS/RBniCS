...
def DecoratedReducedProblemWithStabilityFactorEvaluation(ParametrizedReducedDifferentialProblem_DerivedClass):
    ...
    # Stokes RB reduced problem specialization
    elif issubclass(ParametrizedReducedDifferentialProblem_DerivedClass, StokesRBReducedProblem):
        @PreserveClassName
        class DecoratedReducedProblemWithStabilityFactorEvaluation_Class(DecoratedReducedProblemWithStabilityFactorEvaluation_Class_Base):
            def __init__(self, truth_problem, **kwargs):
                # Call the parent initialization
                DecoratedReducedProblemWithStabilityFactorEvaluation_Class_Base.__init__(self, truth_problem, **kwargs)
                # Update eigen solver parameters
                self._eigen_solver_parameters["stability_factor"]["problem_type"] = "pos_gen_non_hermitian"
