...
StokesUnsteadyPODGalerkinReduction_Base = LinearTimeDependentPODGalerkinReduction(StokesUnsteadyReductionMethod(StokesPODGalerkinReduction))
...
class StokesUnsteadyPODGalerkinReduction(StokesUnsteadyPODGalerkinReduction_Base):
    ...
    def _init_offline(self):
        ...
        output = StokesUnsteadyPODGalerkinReduction_Base._init_offline(self)
    ...
    def update_snapshots_matrix(self, snapshot_and_supremizer_over_time):
        ...
        if self.nested_POD:
            ...
            StokesPODGalerkinReduction.update_snapshots_matrix(self, (snapshot_over_time, supremizer_over_time))
