...
from rbnics.backends.fenics.wrapping import form_argument_space
...
class ParametrizedTensorFactory(BasicParametrizedTensorFactory):
    def __init__(self, form):
        ...
        # Call Parent
        BasicParametrizedTensorFactory.__init__(self, form, spaces, empty_snapshot, rbnics.backends.fenics, rbnics.backends.fenics.wrapping)
