...
def transpose(arg, backend, wrapping, AdditionalFunctionTypes=None, AdditionalIsVector=None, AdditionalIsMatrix=None):
    ...
    if isinstance(arg, backend.FunctionsList):
        return FunctionsList_Transpose(arg, backend, wrapping, FunctionTypes, AdditionalIsVector, AdditionalIsMatrix)
    elif isinstance(arg, backend.BasisFunctionsMatrix):
        return BasisFunctionsMatrix_Transpose(arg, backend, wrapping, FunctionTypes, AdditionalIsVector, AdditionalIsMatrix)
...
class _FunctionsList_BasisFunctionsMatrix_Transpose(object):
    def __init__(self, functions, backend, wrapping, FunctionTypes, AdditionalIsVector, AdditionalIsMatrix, Functions_Transpose__times__Matrix):
    ...
    def __mul__(self, matrix_or_vector):
        assert isinstance(matrix_or_vector, self.FunctionTypes + (self.backend.Matrix.Type(), self.backend.Vector.Type())) or self.AdditionalIsVector(matrix_or_vector) or self.AdditionalIsMatrix(matrix_or_vector)
        if isinstance(matrix_or_vector, self.backend.Matrix.Type()) or self.AdditionalIsMatrix(matrix_or_vector):
            return self.Functions_Transpose__times__Matrix(self.functions_list, self.functions_list_dim, matrix_or_vector, self.backend, self.wrapping, self.FunctionTypes, self.AdditionalIsVector, self.AdditionalIsMatrix)
        elif isinstance(matrix_or_vector, self.FunctionTypes + (self.backend.Vector.Type(), )) or self.AdditionalIsVector(matrix_or_vector):
...
class FunctionsList_Transpose(_FunctionsList_BasisFunctionsMatrix_Transpose):
    def __init__(self, basis_functions_matrix, backend, wrapping, FunctionTypes, AdditionalIsVector, AdditionalIsMatrix):
        _FunctionsList_BasisFunctionsMatrix_Transpose.__init__(self, basis_functions_matrix, backend, wrapping, FunctionTypes, AdditionalIsVector, AdditionalIsMatrix, FunctionsList_Transpose__times__Matrix)
    
class BasisFunctionsMatrix_Transpose(_FunctionsList_BasisFunctionsMatrix_Transpose):
    def __init__(self, basis_functions_matrix, backend, wrapping, FunctionTypes, AdditionalIsVector, AdditionalIsMatrix):
        _FunctionsList_BasisFunctionsMatrix_Transpose.__init__(self, basis_functions_matrix, backend, wrapping, FunctionTypes, AdditionalIsVector, AdditionalIsMatrix, BasisFunctionsMatrix_Transpose__times__Matrix)
...
class _FunctionsList_BasisFunctionsMatrix_Transpose__times__Matrix(object):
    def __init__(self, functions_list, functions_list_dim, matrix, backend, wrapping, FunctionTypes, AdditionalIsVector, AdditionalIsMatrix):
