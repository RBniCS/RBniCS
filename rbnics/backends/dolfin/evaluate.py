...
wrapping = ModuleWrapper(assemble, assert_lagrange_1, expression_iterator, expression_replace, form_argument_replace, form_iterator, form_replace, is_problem_solution_or_problem_solution_component, is_problem_solution_or_problem_solution_component_type, solution_identify_component, solution_iterator, ufl_lagrange_interpolation, get_auxiliary_problem_for_non_parametrized_function=get_auxiliary_problem_for_non_parametrized_function) # temporarily
expression_on_reduced_mesh = basic_expression_on_reduced_mesh(backend, wrapping)
expression_on_truth_mesh = basic_expression_on_truth_mesh(backend, wrapping)
form_on_reduced_function_space = basic_form_on_reduced_function_space(backend, wrapping)
form_on_truth_function_space = basic_form_on_truth_function_space(backend, wrapping)
