...
def get_global_dof_to_local_dof_map(V, dofmap):
    if V not in get_global_dof_to_local_dof_map._storage:
        ...
        get_global_dof_to_local_dof_map._storage[V] = global_to_local
    return get_global_dof_to_local_dof_map._storage[V]
get_global_dof_to_local_dof_map._storage = dict()
