...
def basic_get_auxiliary_problem_for_non_parametrized_function(backend, wrapping):
    ...
    _basic_get_auxiliary_problem_for_non_parametrized_function._storage_problem = dict()
    _basic_get_auxiliary_problem_for_non_parametrized_function._storage_component = dict()
