...
from rbnics.backends.dolfin.wrapping import expression_description, expression_iterator, expression_name, get_auxiliary_problem_for_non_parametrized_function, is_parametrized, is_problem_solution, is_problem_solution_type, is_time_dependent, solution_identify_component, solution_iterator
...
wrapping = ModuleWrapper(expression_iterator, is_problem_solution, is_problem_solution_type, solution_identify_component, solution_iterator, expression_description=expression_description, expression_name=expression_name, get_auxiliary_problem_for_non_parametrized_function=get_auxiliary_problem_for_non_parametrized_function, is_parametrized=is_parametrized, is_time_dependent=is_time_dependent)
