...
from rbnics.backends.dolfin.wrapping import expression_description, expression_iterator, expression_name, is_parametrized, is_problem_solution_or_problem_solution_component, is_problem_solution_or_problem_solution_component_type, is_time_dependent, solution_identify_component, solution_iterator
...
wrapping = ModuleWrapper(expression_iterator, is_problem_solution_or_problem_solution_component, is_problem_solution_or_problem_solution_component_type, solution_identify_component, solution_iterator, expression_description=expression_description, expression_name=expression_name, is_parametrized=is_parametrized, is_time_dependent=is_time_dependent)
