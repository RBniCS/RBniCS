...
from rbnics.backends.dolfin.wrapping import build_dof_map_writer_mapping, form_argument_space, form_name, function_extend_or_restrict, function_from_ufl_operators, function_save, get_function_subspace, to_petsc4py
...
wrapping_for_wrapping = ModuleWrapper(build_dof_map_writer_mapping, form_argument_space, to_petsc4py, form_name=form_name)
...
@backend_for("dolfin", inputs=((Function.Type(), Matrix.Type(), Operator, Vector.Type()), (Folders.Folder, str), str, (int, None), (int, str, None)))
