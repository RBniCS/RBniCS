...
reduced_gaussian_problem.export_solution("GaussianDEIM", "online_solution")
reduced_gaussian_problem.solve(DEIM=11)
reduced_gaussian_problem.export_solution("GaussianDEIM", "online_solution__DEIM_11")
reduced_gaussian_problem.solve(DEIM=1)
reduced_gaussian_problem.export_solution("GaussianDEIM", "online_solution__DEIM_1")
