...
reduced_gaussian_problem.export_solution("GaussianEIM", "online_solution")
reduced_gaussian_problem.solve(EIM=11)
reduced_gaussian_problem.export_solution("GaussianEIM", "online_solution__EIM_11")
reduced_gaussian_problem.solve(EIM=1)
reduced_gaussian_problem.export_solution("GaussianEIM", "online_solution__EIM_1")
