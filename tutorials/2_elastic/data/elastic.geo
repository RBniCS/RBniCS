...
Point(5) = {0, 1/3, 0, 1.0};
Point(6) = {0, 2/3, 0, 1.0};
Point(7) = {1/3, 2/3, 0, 1.0};
Point(8) = {2/3, 2/3, 0, 1.0};
Point(9) = {1, 2/3, 0, 1.0};
Point(10) = {1/3, 0, 0, 1.0};
Point(11) = {1/3, 1, 0, 1.0};
Point(12) = {1/3, 1/3, 0, 1.0};
Point(13) = {2/3, 1/3, 0, 1.0};
Point(14) = {2/3, 0, 0, 1.0};
Point(15) = {2/3, 1, 0, 1.0};
Point(16) = {1, 1/3, 0, 1.0};
Line(1) = {4, 6};
Line(2) = {6, 5};
Line(3) = {1, 5};
Line(4) = {1, 10};
