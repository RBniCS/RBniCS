    ...
    def assemble_operator(self, term):
        ...
        if term == "a":
            ...
            if term == "dirichlet_bc_u":
                ...
                inlet = Constant((0.0, 0.0))
            bc0 = [DirichletBC(V_s, inlet               , self.boundaries, 1),
                   DirichletBC(V_s, Constant((0.0, 0.0)), self.boundaries, 3)]
            return (bc0,)
...
reduced_stokes_problem.export_solution("Stokes4", "online_solution")
