...
reduced_stokes_problem.export_solution("StokesEIM", "online_solution")
...
reduced_advection_diffusion_problem.export_solution("AdvectionDiffusionEIM", "online_solution")
