...
GeostrophicOptimalControlPODGalerkinReducedProblem_Base = LinearPODGalerkinReducedProblem(GeostrophicOptimalControlReducedProblem(ParametrizedReducedDifferentialProblem))
