                ...
                for term in self.terms:
                    ...
                    for (q, form_q) in enumerate(forms):
                        ...
                        if separated_form_q.is_parametrized():
                            self.DEIM_approximations[term][q] = DEIMApproximation(self, ParametrizedTensorFactory(form_q, separated_form_q.name()), type(self).__name__ + "/deim/" + separated_form_q.name(), basis_generation)
                        else:
