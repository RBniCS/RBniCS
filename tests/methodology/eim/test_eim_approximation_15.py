    ...
    * DEIM: the solution component is not further split between x and y. This results in a single coefficient
    ...
    class MockProblem(ParametrizedProblem):
        def __init__(self, V, **kwargs):
            # Call parent
            ParametrizedProblem.__init__(self, os.path.join("test_eim_approximation_15.output_dir", expression_type, basis_generation, "mock_problem"))
    ...
    class MockReductionMethod(ReductionMethod):
        def __init__(self, truth_problem, **kwargs):
            # Call parent
            ReductionMethod.__init__(self, os.path.join("test_eim_approximation_15.output_dir", expression_type, basis_generation, "mock_problem"), truth_problem.mu_range)
    ...
    class ParametrizedFunctionApproximation(EIMApproximation):
        def __init__(self, truth_problem, expression_type, basis_generation):
            ...
            #
            folder_prefix = os.path.join("test_eim_approximation_15.output_dir", expression_type, basis_generation)
