...
def test_eim_approximation_22(expression_type, basis_generation):
    ...
    class MockProblem(ParametrizedProblem):
        def __init__(self, V, **kwargs):
            # Call parent
            ParametrizedProblem.__init__(self, os.path.join("test_eim_approximation_22.output_dir", expression_type, basis_generation, "mock_problem"))
    ...
    class ParametrizedFunctionApproximation(EIMApproximation):
        def __init__(self, truth_problem, expression_type, basis_generation):
            ...
            #
            folder_prefix = os.path.join("test_eim_approximation_22.output_dir", expression_type, basis_generation)
