...
subdomains = MeshFunction("size_t", mesh, "../../../tutorials/05_gaussian/data/gaussian_physical_region.xml")
boundaries = MeshFunction("size_t", mesh, "../../../tutorials/05_gaussian/data/gaussian_facet_region.xml")
