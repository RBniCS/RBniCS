...
def test_compute_shape_parametrization_gradient_hole_rotation():
    ...
    assert len(shape_parametrization_gradient_expression[0]) is 2
    assert len(shape_parametrization_gradient_expression[0][X]) is 2
    assert symbolic_equal(shape_parametrization_gradient_expression[0][X][X], "sqrt(2.0)*sin(mu[0])/2 + sqrt(2.0)*cos(mu[0])/2", x, mu)
    assert symbolic_equal(shape_parametrization_gradient_expression[0][X][Y], "-sqrt(2.0)*sin(mu[0])/2 - 3*sqrt(2.0)*cos(mu[0])/2 + 2", x, mu)
    assert len(shape_parametrization_gradient_expression[0][Y]) is 2
    assert symbolic_equal(shape_parametrization_gradient_expression[0][Y][X], "sqrt(2.0)*sin(mu[0])/2 - sqrt(2.0)*cos(mu[0])/2", x, mu)
    assert symbolic_equal(shape_parametrization_gradient_expression[0][Y][Y], "-3*sqrt(2.0)*sin(mu[0])/2 + sqrt(2.0)*cos(mu[0])/2 + 2", x, mu)
    # Check subdomain 2
    assert len(shape_parametrization_gradient_expression[1]) is 2
    assert len(shape_parametrization_gradient_expression[1][X]) is 2
    assert symbolic_equal(shape_parametrization_gradient_expression[1][X][X], "1", x, mu)
    assert symbolic_equal(shape_parametrization_gradient_expression[1][X][Y], "sqrt(2.0)*sin(mu[0]) - 1", x, mu)
    assert len(shape_parametrization_gradient_expression[1][Y]) is 2
    assert symbolic_equal(shape_parametrization_gradient_expression[1][Y][X], "0", x, mu)
    assert symbolic_equal(shape_parametrization_gradient_expression[1][Y][Y], "-sqrt(2.0)*cos(mu[0]) + 2", x, mu)
    # Check subdomain 3
    assert len(shape_parametrization_gradient_expression[2]) is 2
    assert len(shape_parametrization_gradient_expression[2][X]) is 2
    assert symbolic_equal(shape_parametrization_gradient_expression[2][X][X], "sqrt(2.0)*sin(mu[0])/2 - 3*sqrt(2.0)*cos(mu[0])/2 + 2", x, mu)
    assert symbolic_equal(shape_parametrization_gradient_expression[2][X][Y], "-sqrt(2.0)*sin(mu[0])/2 + sqrt(2.0)*cos(mu[0])/2", x, mu)
    assert len(shape_parametrization_gradient_expression[2][Y]) is 2
    assert symbolic_equal(shape_parametrization_gradient_expression[2][Y][X], "-3*sqrt(2.0)*sin(mu[0])/2 - sqrt(2.0)*cos(mu[0])/2 + 2", x, mu)
    assert symbolic_equal(shape_parametrization_gradient_expression[2][Y][Y], "sqrt(2.0)*sin(mu[0])/2 + sqrt(2.0)*cos(mu[0])/2", x, mu)
    # Check subdomain 4
    assert len(shape_parametrization_gradient_expression[3]) is 2
    assert len(shape_parametrization_gradient_expression[3][X]) is 2
    assert symbolic_equal(shape_parametrization_gradient_expression[3][X][X], "-sqrt(2.0)*sin(mu[0]) + 2", x, mu)
    assert symbolic_equal(shape_parametrization_gradient_expression[3][X][Y], "0", x, mu)
    assert len(shape_parametrization_gradient_expression[3][Y]) is 2
    assert symbolic_equal(shape_parametrization_gradient_expression[3][Y][X], "sqrt(2.0)*cos(mu[0]) - 1", x, mu)
    assert symbolic_equal(shape_parametrization_gradient_expression[3][Y][Y], "1", x, mu)
    # Check subdomain 5
    assert len(shape_parametrization_gradient_expression[4]) is 2
    assert len(shape_parametrization_gradient_expression[4][X]) is 2
    assert symbolic_equal(shape_parametrization_gradient_expression[4][X][X], "-3*sqrt(2.0)*sin(mu[0])/2 + sqrt(2.0)*cos(mu[0])/2 + 2", x, mu)
    assert symbolic_equal(shape_parametrization_gradient_expression[4][X][Y], "-sqrt(2.0)*sin(mu[0])/2 + sqrt(2.0)*cos(mu[0])/2", x, mu)
    assert len(shape_parametrization_gradient_expression[4][Y]) is 2
    assert symbolic_equal(shape_parametrization_gradient_expression[4][Y][X], "sqrt(2.0)*sin(mu[0])/2 + 3*sqrt(2.0)*cos(mu[0])/2 - 2", x, mu)
    assert symbolic_equal(shape_parametrization_gradient_expression[4][Y][Y], "sqrt(2.0)*sin(mu[0])/2 + sqrt(2.0)*cos(mu[0])/2", x, mu)
    # Check subdomain 6
    assert len(shape_parametrization_gradient_expression[5]) is 2
    assert len(shape_parametrization_gradient_expression[5][X]) is 2
    assert symbolic_equal(shape_parametrization_gradient_expression[5][X][X], "-sqrt(2.0)*cos(mu[0]) + 2", x, mu)
    assert symbolic_equal(shape_parametrization_gradient_expression[5][X][Y], "0", x, mu)
    assert len(shape_parametrization_gradient_expression[5][Y]) is 2
    assert symbolic_equal(shape_parametrization_gradient_expression[5][Y][X], "-sqrt(2.0)*sin(mu[0]) + 1", x, mu)
    assert symbolic_equal(shape_parametrization_gradient_expression[5][Y][Y], "1", x, mu)
    # Check subdomain 7
    assert len(shape_parametrization_gradient_expression[6]) is 2
    assert len(shape_parametrization_gradient_expression[6][X]) is 2
    assert symbolic_equal(shape_parametrization_gradient_expression[6][X][X], "sqrt(2.0)*sin(mu[0])/2 + sqrt(2.0)*cos(mu[0])/2", x, mu)
    assert symbolic_equal(shape_parametrization_gradient_expression[6][X][Y], "3*sqrt(2.0)*sin(mu[0])/2 + sqrt(2.0)*cos(mu[0])/2 - 2", x, mu)
    assert len(shape_parametrization_gradient_expression[6][Y]) is 2
    assert symbolic_equal(shape_parametrization_gradient_expression[6][Y][X], "sqrt(2.0)*sin(mu[0])/2 - sqrt(2.0)*cos(mu[0])/2", x, mu)
    assert symbolic_equal(shape_parametrization_gradient_expression[6][Y][Y], "sqrt(2.0)*sin(mu[0])/2 - 3*sqrt(2.0)*cos(mu[0])/2 + 2", x, mu)
    # Check subdomain 8
    assert len(shape_parametrization_gradient_expression[7]) is 2
    assert len(shape_parametrization_gradient_expression[7][X]) is 2
    assert symbolic_equal(shape_parametrization_gradient_expression[7][X][X], "1", x, mu)
    assert symbolic_equal(shape_parametrization_gradient_expression[7][X][Y], "-sqrt(2.0)*cos(mu[0]) + 1", x, mu)
...
def test_compute_shape_parametrization_gradient_stokes():
    shape_parametrization_expression = [
        ...
        ("mu[4]*x[0] + mu[1] - mu[4]", "mu[4]*tan(mu[5])*x[0] + mu[0]*x[1] + mu[2] - tan(mu[5]) - mu[0]"), # subdomain 2
