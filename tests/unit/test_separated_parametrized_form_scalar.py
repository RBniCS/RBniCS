...
def test_separated_parametrized_forms_scalar_1():
    ...
    log(DEBUG, "*** ###              FORM 1             ### ***")
    log(DEBUG, "This is a basic advection-diffusion-reaction parametrized form, with all parametrized coefficients")
    a1_sep.separate()
...
def test_separated_parametrized_forms_scalar_2():
    ...
    log(DEBUG, "*** ###              FORM 2             ### ***")
    log(DEBUG, "We move the diffusion coefficient inside the inner product, splitting it into two coefficients: note that coefficient extraction was forced to extract two coefficients because they were separated in the UFL tree")
    a2_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_3():
    ...
    log(DEBUG, "*** ###              FORM 3             ### ***")
    log(DEBUG, "This form tests the expansion of a sum of coefficients")
    a3_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_4():
    ...
    log(DEBUG, "*** ###              FORM 4             ### ***")
    log(DEBUG, "We use a diffusivity tensor now. The extraction is able to correctly detect the matrix.")
    a4_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_5():
    ...
    log(DEBUG, "*** ###              FORM 5             ### ***")
    log(DEBUG, "We change the integration domain to be the boundary. The result is the same as form 1")
    a5_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_6():
    ...
    log(DEBUG, "*** ###              FORM 6             ### ***")
    log(DEBUG, "We add a term depending on the mesh size. The extracted coefficient does not retain the mesh size factor")
    a6_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_9():
    ...
    log(DEBUG, "*** ###              FORM 9             ### ***")
    log(DEBUG, "A part of the diffusion coefficient is parametrized (advection-reaction are not parametrized), where the terms are written in a different way when compared to form 8. Due to the UFL tree this would entail to extract two (\"sub\") coefficients, but this is not done for the sake of efficiency")
    a9_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_10():
    ...
    log(DEBUG, "*** ###              FORM 10             ### ***")
    log(DEBUG, "Similarly to form 6, we add a term depending on the mesh size multiplied by a non-parametrized coefficient. Neither are retained")
    a10_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_11():
    ...
    log(DEBUG, "*** ###              FORM 11             ### ***")
    log(DEBUG, "Similarly to form 6, we add a term depending on the mesh size multiplied by the product of parametrized and a non-parametrized coefficients. Neither the non-parametrized coefficient nor the mesh size are retained")
    a11_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_12():
    ...
    log(DEBUG, "*** ###              FORM 12             ### ***")
    log(DEBUG, "We change form 11 with a slightly differenc coefficient. In this case the extraction retains the mesh size")
    a12_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_13():
    ...
    log(DEBUG, "*** ###              FORM 13             ### ***")
    log(DEBUG, "Constants are factored out.")
    a13_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_14():
    ...
    log(DEBUG, "*** ###              FORM 14             ### ***")
    log(DEBUG, "This form is similar to form 1, but each term is multiplied by a scalar Function, which is the solution of a parametrized problem")
    a14_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_15():
    ...
    log(DEBUG, "*** ###              FORM 15             ### ***")
    log(DEBUG, "This form is similar to form 4, but each term is replace by a solution of a parametrized problem, either scalar, vector or tensor shaped")
    a15_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_16():
    ...
    log(DEBUG, "*** ###              FORM 16             ### ***")
    log(DEBUG, "We change the coefficients of form 14 to be non-parametrized (as in form 7). Due to the presence of solutions of parametrized problems in contrast to form 7 all coefficients are now parametrized.")
    a16_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_17():
    ...
    log(DEBUG, "*** ###              FORM 17             ### ***")
    log(DEBUG, "This form is similar to form 15, but each term is multiplied to a component of a solution of a parametrized problem")
    a17_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_18():
    ...
    log(DEBUG, "*** ###              FORM 18             ### ***")
    log(DEBUG, "This form is similar to form 14, but each term is multiplied by a scalar Function, which is not the solution of a parametrized problem")
    a18_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_19():
    ...
    log(DEBUG, "*** ###              FORM 19             ### ***")
    log(DEBUG, "This form is similar to form 16, but each term is multiplied by a scalar Function, which is not the solution of a parametrized problem. As in form 7, no parametrized coefficients are detected")
    a19_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_20():
    ...
    log(DEBUG, "*** ###              FORM 20             ### ***")
    log(DEBUG, "This form is similar to form 17, but each term is multiplied to a component of a Function which is not the solution of a parametrized problem. This results in no parametrized coefficients")
    a20_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_21():
    ...
    log(DEBUG, "*** ###              FORM 21             ### ***")
    log(DEBUG, "This form is similar to form 17, but each term is multiplied to the gradient/partial derivative of a component of a solution of a parametrized problem")
    a21_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_22():
    ...
    log(DEBUG, "*** ###              FORM 22             ### ***")
    log(DEBUG, "This form is similar to form 21, but each term is multiplied to the gradient/partial derivative of a component of a Function which is not the solution of a parametrized problem. This results in no parametrized coefficients")
    a22_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_23():
    ...
    log(DEBUG, "*** ###              FORM 23             ### ***")
    log(DEBUG, "This form tests a division between two expressions, which can be collected as one coefficient")
    a23_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_scalar_24():
    ...
    log(DEBUG, "*** ###              FORM 24             ### ***")
    log(DEBUG, "This form tests a division between two expressions, which (in contrast to form 24) cannot be collected as one coefficient")
    a24_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
