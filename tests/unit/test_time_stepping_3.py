...
"""
Solve
    u_tt - u_xx = g,  (t, x) in [0, 1] x [0, 2*pi]
...
# ~~~ Sparse case ~~~ #
def _test_time_stepping_3_sparse(callback_type):
    ...
    g = Expression("0.", t=0., element=V.ufl_element())
...
# ~~~ Test function ~~~ #
def test_time_stepping_3():
    error_sparse_tensor_callbacks = _test_time_stepping_3_sparse("tensor callbacks")
    error_sparse_form_callbacks = _test_time_stepping_3_sparse("form callbacks")
