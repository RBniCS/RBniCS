...
def test_separated_parametrized_forms_vector_1():
    ...
    test_logger.log(DEBUG, "This is a basic vector advection-diffusion-reaction parametrized form, with all parametrized coefficients")
    a1_sep.separate()
...
def test_separated_parametrized_forms_vector_7():
    ...
    test_logger.log(DEBUG, "A part of the diffusion coefficient is parametrized (advection-reaction are not parametrized). Only the parametrized part is extracted.")
    a7_sep.separate()
    test_logger.log(DEBUG, "\tLen coefficients:")
...
def test_separated_parametrized_forms_vector_12():
    ...
    test_logger.log(DEBUG, "This form is similar to form 11, but each term is multiplied by a component of a solution of a parametrized problem, resulting in an Indexed coefficient")
    a12_sep.separate()
    test_logger.log(DEBUG, "\tLen coefficients:")
...
def test_separated_parametrized_forms_vector_13():
    ...
    test_logger.log(DEBUG, "This form is similar to form 11, but each term is multiplied by a Function, which is not the solution of a parametrized problem. This results in no parametrized coefficients")
    a13_sep.separate()
    test_logger.log(DEBUG, "\tLen coefficients:")
...
def test_separated_parametrized_forms_vector_14():
    ...
    test_logger.log(DEBUG, "This form is similar to form 12, but each term is multiplied by a component of a Function which is not solution of a parametrized problem. This results in no parametrized coefficients")
    a14_sep.separate()
    test_logger.log(DEBUG, "\tLen coefficients:")
...
def test_separated_parametrized_forms_vector_16():
    ...
    test_logger.log(DEBUG, "This form is similar to form 12, but each term is multiplied by the gradient/partial derivative of a component of a solution of a parametrized problem")
    a16_sep.separate()
    test_logger.log(DEBUG, "\tLen coefficients:")
...
def test_separated_parametrized_forms_vector_17():
    ...
    test_logger.log(DEBUG, "This form is similar to form 13, but each term is multiplied by a the gradient/partial derivative of Function, which is not the solution of a parametrized problem. This results in no parametrized coefficients")
    a17_sep.separate()
    test_logger.log(DEBUG, "\tLen coefficients:")
...
def test_separated_parametrized_forms_vector_18():
    ...
    test_logger.log(DEBUG, "This form is similar to form 14, but each term is multiplied by the gradient/partial derivative of a component of a Function which is not solution of a parametrized problem. This results in no parametrized coefficients")
    a18_sep.separate()
    test_logger.log(DEBUG, "\tLen coefficients:")
