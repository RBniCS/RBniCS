...
def test_separated_parametrized_forms_vector_1():
    ...
    log(DEBUG, "*** ###              FORM 1             ### ***")
    log(DEBUG, "This is a basic vector advection-diffusion-reaction parametrized form, with all parametrized coefficients")
    a1_sep.separate()
    ...
    assert "sum_{i_{14}} sum_{i_{13}} ({ A | A_{i_8, i_9} = sum_{i_{10}} f_36[i_8, i_{10}] * (grad(v_1))[i_{10}, i_9]  })[i_{13}, i_{14}] * (grad(v_0))[i_{13}, i_{14}]  " == str(a1_sep._form_with_placeholders[0].integrals()[0].integrand())
    assert "sum_{i_{15}} ({ A | A_{i_{11}} = sum_{i_{12}} f_37[i_{12}] * (grad(v_1))[i_{11}, i_{12}]  })[i_{15}] * v_0[i_{15}] " == str(a1_sep._form_with_placeholders[1].integrals()[0].integrand())
    assert "f_38 * (sum_{i_{16}} v_0[i_{16}] * v_1[i_{16}] )" == str(a1_sep._form_with_placeholders[2].integrals()[0].integrand())
...
def test_separated_parametrized_forms_vector_2():
    ...
    assert "{ A | A_{i_{17}, i_{18}} = sum_{i_{19}} f_7[i_{17}, i_{19}] * f_8[i_{19}, i_{18}]  }" == str(a2_sep.coefficients[0][0])
    ...
    assert "sum_{i_{26}} sum_{i_{25}} ({ A | A_{i_{20}, i_{21}} = sum_{i_{22}} f_39[i_{20}, i_{22}] * (grad(v_1))[i_{22}, i_{21}]  })[i_{25}, i_{26}] * (grad(v_0))[i_{25}, i_{26}]  " == str(a2_sep._form_with_placeholders[0].integrals()[0].integrand())
    assert "sum_{i_{27}} ({ A | A_{i_{23}} = sum_{i_{24}} f_40[i_{24}] * (grad(v_1))[i_{23}, i_{24}]  })[i_{27}] * v_0[i_{27}] " == str(a2_sep._form_with_placeholders[1].integrals()[0].integrand())
    assert "f_41 * (sum_{i_{28}} v_0[i_{28}] * v_1[i_{28}] )" == str(a2_sep._form_with_placeholders[2].integrals()[0].integrand())
    log(DEBUG, "\tLen unchanged forms:\n" +
...
def test_separated_parametrized_forms_vector_6():
    ...
    assert "sum_{i_{72}} sum_{i_{71}} ({ A | A_{i_{66}, i_{67}} = sum_{i_{68}} f_11[i_{66}, i_{68}] * (grad(v_1))[i_{68}, i_{67}]  })[i_{71}, i_{72}] * (grad(v_0))[i_{71}, i_{72}]  " == str(a6_sep._form_unchanged[0].integrals()[0].integrand())
    assert "sum_{i_{73}} ({ A | A_{i_{69}} = sum_{i_{70}} f_10[i_{70}] * (grad(v_1))[i_{69}, i_{70}]  })[i_{73}] * v_0[i_{73}] " == str(a6_sep._form_unchanged[1].integrals()[0].integrand())
    assert "f_9 * (sum_{i_{74}} v_0[i_{74}] * v_1[i_{74}] )" == str(a6_sep._form_unchanged[2].integrals()[0].integrand())
...
def test_separated_parametrized_forms_vector_7():
    ...
    log(DEBUG, "*** ###              FORM 7             ### ***")
    log(DEBUG, "A part of the diffusion coefficient is parametrized (advection-reaction are not parametrized). Only the parametrized part is extracted.")
    a7_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
    ...
    assert "{ A | A_{i_{75}, i_{76}} = sum_{i_{77}} f_7[i_{75}, i_{77}] * f_8[i_{77}, i_{76}]  }" == str(a7_sep.coefficients[0][0])
    log(DEBUG, "\tPlaceholders:\n" +
    ...
    assert "sum_{i_{87}} sum_{i_{86}} ({ A | A_{i_{81}, i_{82}} = sum_{i_{83}} ({ A | A_{i_{78}, i_{79}} = sum_{i_{80}} f_11[i_{78}, i_{80}] * f_54[i_{80}, i_{79}]  })[i_{81}, i_{83}] * (grad(v_1))[i_{83}, i_{82}]  })[i_{86}, i_{87}] * (grad(v_0))[i_{86}, i_{87}]  " == str(a7_sep._form_with_placeholders[0].integrals()[0].integrand())
    log(DEBUG, "\tLen unchanged forms:\n" +
    ...
    assert "sum_{i_{88}} ({ A | A_{i_{84}} = sum_{i_{85}} f_10[i_{85}] * (grad(v_1))[i_{84}, i_{85}]  })[i_{88}] * v_0[i_{88}] " == str(a7_sep._form_unchanged[0].integrals()[0].integrand())
    assert "f_9 * (sum_{i_{89}} v_0[i_{89}] * v_1[i_{89}] )" == str(a7_sep._form_unchanged[1].integrals()[0].integrand())
...
def test_separated_parametrized_forms_vector_8():
    ...
    assert "{ A | A_{i_{93}, i_{94}} = sum_{i_{95}} ({ A | A_{i_{90}, i_{91}} = sum_{i_{92}} f_7[i_{90}, i_{92}] * f_11[i_{92}, i_{91}]  })[i_{93}, i_{95}] * f_8[i_{95}, i_{94}]  }" == str(a8_sep.coefficients[0][0])
    log(DEBUG, "\tPlaceholders:\n" +
    ...
    assert "sum_{i_{102}} sum_{i_{101}} ({ A | A_{i_{96}, i_{97}} = sum_{i_{98}} f_55[i_{96}, i_{98}] * (grad(v_1))[i_{98}, i_{97}]  })[i_{101}, i_{102}] * (grad(v_0))[i_{101}, i_{102}]  " == str(a8_sep._form_with_placeholders[0].integrals()[0].integrand())
    log(DEBUG, "\tLen unchanged forms:\n" +
    ...
    assert "sum_{i_{103}} ({ A | A_{i_{99}} = sum_{i_{100}} f_10[i_{100}] * (grad(v_1))[i_{99}, i_{100}]  })[i_{103}] * v_0[i_{103}] " == str(a8_sep._form_unchanged[0].integrals()[0].integrand())
    assert "f_9 * (sum_{i_{104}} v_0[i_{104}] * v_1[i_{104}] )" == str(a8_sep._form_unchanged[1].integrals()[0].integrand())
...
def test_separated_parametrized_forms_vector_9():
    ...
    assert "{ A | A_{i_{105}, i_{106}} = sum_{i_{107}} f_7[i_{105}, i_{107}] * f_8[i_{107}, i_{106}]  }" == str(a9_sep.coefficients[0][0])
    log(DEBUG, "\tPlaceholders:\n" +
    ...
    assert "sum_{i_{117}} sum_{i_{116}} ({ A | A_{i_{111}, i_{112}} = sum_{i_{113}} ({ A | A_{i_{108}, i_{109}} = sum_{i_{110}} f_13[i_{108}, i_{110}] * f_56[i_{110}, i_{109}]  })[i_{111}, i_{113}] * (grad(v_1))[i_{113}, i_{112}]  })[i_{116}, i_{117}] * (grad(v_0))[i_{116}, i_{117}]  " == str(a9_sep._form_with_placeholders[0].integrals()[0].integrand())
    log(DEBUG, "\tLen unchanged forms:\n" +
    ...
    assert "sum_{i_{118}} ({ A | A_{i_{114}} = sum_{i_{115}} f_10[i_{115}] * (grad(v_1))[i_{114}, i_{115}]  })[i_{118}] * v_0[i_{118}] " == str(a9_sep._form_unchanged[0].integrals()[0].integrand())
    assert "f_9 * (sum_{i_{119}} v_0[i_{119}] * v_1[i_{119}] )" == str(a9_sep._form_unchanged[1].integrals()[0].integrand())
...
def test_separated_parametrized_forms_vector_10():
    ...
    assert "{ A | A_{i_{123}, i_{124}} = sum_{i_{125}} ({ A | A_{i_{120}, i_{121}} = sum_{i_{122}} f_7[i_{120}, i_{122}] * f_13[i_{122}, i_{121}]  })[i_{123}, i_{125}] * f_8[i_{125}, i_{124}]  }" == str(a10_sep.coefficients[0][0])
    log(DEBUG, "\tPlaceholders:\n" +
    ...
    assert "sum_{i_{132}} sum_{i_{131}} ({ A | A_{i_{126}, i_{127}} = sum_{i_{128}} f_57[i_{126}, i_{128}] * (grad(v_1))[i_{128}, i_{127}]  })[i_{131}, i_{132}] * (grad(v_0))[i_{131}, i_{132}]  " == str(a10_sep._form_with_placeholders[0].integrals()[0].integrand())
    log(DEBUG, "\tLen unchanged forms:\n" +
    ...
    assert "sum_{i_{133}} ({ A | A_{i_{129}} = sum_{i_{130}} f_10[i_{130}] * (grad(v_1))[i_{129}, i_{130}]  })[i_{133}] * v_0[i_{133}] " == str(a10_sep._form_unchanged[0].integrals()[0].integrand())
    assert "f_9 * (sum_{i_{134}} v_0[i_{134}] * v_1[i_{134}] )" == str(a10_sep._form_unchanged[1].integrals()[0].integrand())
...
def test_separated_parametrized_forms_vector_11():
    ...
    assert "sum_{i_{141}} sum_{i_{140}} ({ A | A_{i_{135}, i_{136}} = sum_{i_{137}} f_62[i_{135}, i_{137}] * (grad(v_1))[i_{137}, i_{136}]  })[i_{140}, i_{141}] * (grad(v_0))[i_{140}, i_{141}]  " == str(a11_sep._form_with_placeholders[0].integrals()[0].integrand())
    assert "sum_{i_{142}} ({ A | A_{i_{138}} = sum_{i_{139}} f_63[i_{139}] * (grad(v_1))[i_{138}, i_{139}]  })[i_{142}] * v_0[i_{142}] " == str(a11_sep._form_with_placeholders[1].integrals()[0].integrand())
    assert "f_64 * (sum_{i_{143}} v_0[i_{143}] * v_1[i_{143}] )" == str(a11_sep._form_with_placeholders[2].integrals()[0].integrand())
    log(DEBUG, "\tLen unchanged forms:\n" +
...
def test_separated_parametrized_forms_vector_12():
    ...
    log(DEBUG, "*** ###              FORM 12             ### ***")
    log(DEBUG, "This form is similar to form 11, but each term is multiplied by a component of a solution of a parametrized problem, resulting in an Indexed coefficient")
    a12_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
    ...
    assert "f_65 * (sum_{i_{144}} v_0[i_{144}] * v_1[i_{144}] )" == str(a12_sep._form_with_placeholders[0].integrals()[0].integrand())
    log(DEBUG, "\tLen unchanged forms:\n" +
...
def test_separated_parametrized_forms_vector_13():
    ...
    log(DEBUG, "*** ###              FORM 13             ### ***")
    log(DEBUG, "This form is similar to form 11, but each term is multiplied by a Function, which is not the solution of a parametrized problem. This results in no parametrized coefficients")
    a13_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
    ...
    assert "sum_{i_{151}} sum_{i_{150}} ({ A | A_{i_{145}, i_{146}} = sum_{i_{147}} f_33[i_{145}, i_{147}] * (grad(v_1))[i_{147}, i_{146}]  })[i_{150}, i_{151}] * (grad(v_0))[i_{150}, i_{151}]  " == str(a13_sep._form_unchanged[0].integrals()[0].integrand())
    assert "sum_{i_{152}} ({ A | A_{i_{148}} = sum_{i_{149}} f_30[i_{149}] * (grad(v_1))[i_{148}, i_{149}]  })[i_{152}] * v_0[i_{152}] " == str(a13_sep._form_unchanged[1].integrals()[0].integrand())
    assert "f_27 * (sum_{i_{153}} v_0[i_{153}] * v_1[i_{153}] )" == str(a13_sep._form_unchanged[2].integrals()[0].integrand())
...
def test_separated_parametrized_forms_vector_14():
    ...
    log(DEBUG, "*** ###              FORM 14             ### ***")
    log(DEBUG, "This form is similar to form 12, but each term is multiplied by a component of a Function which is not solution of a parametrized problem. This results in no parametrized coefficients")
    a14_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
...
def test_separated_parametrized_forms_vector_15():
    ...
    assert "sum_{i_{161}} sum_{i_{160}} ({ A | A_{i_{155}, i_{156}} = sum_{i_{157}} f_66[i_{155}, i_{157}] * (grad(v_1))[i_{157}, i_{156}]  })[i_{160}, i_{161}] * (grad(v_0))[i_{160}, i_{161}]  " == str(a15_sep._form_with_placeholders[0].integrals()[0].integrand())
    assert "sum_{i_{162}} ({ A | A_{i_{158}} = sum_{i_{159}} f_67[i_{159}] * (grad(v_1))[i_{158}, i_{159}]  })[i_{162}] * v_0[i_{162}] " == str(a15_sep._form_with_placeholders[1].integrals()[0].integrand())
    assert "f_68 * (sum_{i_{163}} v_0[i_{163}] * v_1[i_{163}] )" == str(a15_sep._form_with_placeholders[2].integrals()[0].integrand())
    log(DEBUG, "\tLen unchanged forms:\n" +
...
def test_separated_parametrized_forms_vector_16():
    ...
    log(DEBUG, "*** ###              FORM 16             ### ***")
    log(DEBUG, "This form is similar to form 12, but each term is multiplied by the gradient/partial derivative of a component of a solution of a parametrized problem")
    a16_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
    ...
    assert "v_0[0] * (sum_{i_{164}} f_69[0, i_{164}] * v_1[i_{164}] )" == str(a16_sep._form_with_placeholders[0].integrals()[0].integrand())
    assert "f_70 * (sum_{i_{165}} v_0[i_{165}] * v_1[i_{165}] )" == str(a16_sep._form_with_placeholders[1].integrals()[0].integrand())
    log(DEBUG, "\tLen unchanged forms:\n" +
...
def test_separated_parametrized_forms_vector_17():
    ...
    log(DEBUG, "*** ###              FORM 17             ### ***")
    log(DEBUG, "This form is similar to form 13, but each term is multiplied by a the gradient/partial derivative of Function, which is not the solution of a parametrized problem. This results in no parametrized coefficients")
    a17_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
    ...
    assert "sum_{i_{174}} sum_{i_{173}} ({ A | A_{i_{168}, i_{169}} = sum_{i_{170}} (grad(v_1))[i_{170}, i_{169}] * (grad(f_30))[i_{168}, i_{170}]  })[i_{173}, i_{174}] * (grad(v_0))[i_{173}, i_{174}]  " == str(a17_sep._form_unchanged[0].integrals()[0].integrand())
    assert "sum_{i_{175}} ({ A | A_{i_{171}} = sum_{i_{172}} (grad(v_1))[i_{171}, i_{172}] * (grad(f_27))[i_{172}]  })[i_{175}] * v_0[i_{175}] " == str(a17_sep._form_unchanged[1].integrals()[0].integrand())
    assert "(grad(f_27))[0] * (sum_{i_{176}} v_0[i_{176}] * v_1[i_{176}] )" == str(a17_sep._form_unchanged[2].integrals()[0].integrand())
...
def test_separated_parametrized_forms_vector_18():
    ...
    log(DEBUG, "*** ###              FORM 18             ### ***")
    log(DEBUG, "This form is similar to form 14, but each term is multiplied by the gradient/partial derivative of a component of a Function which is not solution of a parametrized problem. This results in no parametrized coefficients")
    a18_sep.separate()
    log(DEBUG, "\tLen coefficients:\n" +
    ...
    assert "v_0[0] * (sum_{i_{177}} (grad(f_30))[0, i_{177}] * v_1[i_{177}] )" == str(a18_sep._form_unchanged[0].integrals()[0].integrand())
    assert "(grad(f_30))[0, 0] * (sum_{i_{178}} v_0[i_{178}] * v_1[i_{178}] )" == str(a18_sep._form_unchanged[1].integrals()[0].integrand())
